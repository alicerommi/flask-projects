...
while True:
    results = engine.execute("""SELECT reference_no FROM "tide_work2" where customs_release_status !="CLEARED" or line_release_status !='PAID' or
    ...
    try:
        ...
        for i in range(len(df)):
            ...
            sql = """update 'tide_work2' set email = (?) where reference_no = (?)"""
